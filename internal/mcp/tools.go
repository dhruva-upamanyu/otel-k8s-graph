...
type SearchInput struct {
	...
	Kind  string `json:"kind,omitempty" jsonschema:"optional entity kind filter: namespace | node | zone | region | deployment | statefulset | daemonset | job | cronjob | rollout | pod | container | hpa | scaledobject | endpoint | topic | database. Omit to search all kinds."`
...
type ListEntitiesInput struct {
	Kind string `json:"kind" jsonschema:"required entity kind to enumerate: namespace | node | zone | region | deployment | statefulset | daemonset | job | cronjob | rollout | pod | container | hpa | scaledobject | endpoint | topic | database"`
}
